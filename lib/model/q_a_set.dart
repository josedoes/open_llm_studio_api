...
class QASet extends Equatable {
  QASet(
      {required this.id,
      required this.name,
      required this.backgroundKnoledge,
  ...
  Map<String, dynamic> toJson() {
    return {
      'id': id,
      'name': name,
      'backgroundKnoledge': backgroundKnoledge,
      'questions': questions,
      'answers': answers
    };
  }
  ...
  factory QASet.fromJson(Map<String, dynamic> map) {
    return QASet(
        id: map['id'],
        name: map['name'],
        backgroundKnoledge: map['backgroundKnoledge'],
  ...
  QASet copyWith(
      {String? id,
      String? name,
      String? backgroundKnoledge,
      List<String>? questions,
      List<String>? answers}) {
    return QASet(
        id: id ?? this.id,
        name: name ?? this.name,
        backgroundKnoledge: backgroundKnoledge ?? this.backgroundKnoledge,
