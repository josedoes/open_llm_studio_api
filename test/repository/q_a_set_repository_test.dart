...
main() {
  var repo = QASetRepository();
  var service = MockQASetService();
  var model = QASet.fromJson(QASet.exampleJson());
  ...
  setUp(() async {
    ...
    repo = QASetRepository();
    service = MockQASetService();
  });

  group('QASetRepository can', () {
    test('create', () async {
...
class MockQASetService extends Mock implements QASetService {
  MockQASetService() {
    GetIt.instance.registerSingleton<QASetService>(this);
  }
}
