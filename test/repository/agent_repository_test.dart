...
main() {
  ...
  var service = MockAgentService();
  var model = Agent.fromJson(Agent.exampleJson());
  ...
  group('AgentRepository can', () {
    test('create', () async {
      ...
      expect(repo.agentCache.length, 1);
    });
...
class MockAgentService extends Mock implements AgentService {
  MockAgentService() {
    GetIt.instance.registerSingleton<AgentService>(this);
  }
}
