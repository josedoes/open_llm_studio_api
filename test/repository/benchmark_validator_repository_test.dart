...
import 'package:open_llm_studio_api/repository/benchmark_validator_repository.dart';
import 'package:open_llm_studio_api/service/benchmark_validator_service.dart';
import 'package:mocktail/mocktail.dart';

main() {
  var repo = BenchmarkValidatorRepository();
  var service = MockBenchmarkValidatorService();
  var model = BenchmarkValidator.fromJson(BenchmarkValidator.exampleJson());
  ...
  setUp(() async {
    ...
    repo = BenchmarkValidatorRepository();
    service = MockBenchmarkValidatorService();
  });

  group('BenchmarkValidatorRepository can', () {
    test('create', () async {
  ...
  test('ReadAll', () async {
      final exampleModel = BenchmarkValidator.fromJson(BenchmarkValidator.exampleJson());
...
class MockBenchmarkValidatorService extends Mock implements BenchmarkValidatorService {
  MockBenchmarkValidatorService() {
    GetIt.instance.registerSingleton<BenchmarkValidatorService>(this);
  }
}
